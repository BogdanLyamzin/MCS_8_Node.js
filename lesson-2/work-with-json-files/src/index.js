import { getAllMovies, getMovieById, addMovie, updateMovieById, deleteMovieById } from "./movies.js";
...
// invokeAction({action: "updateById", id: "ubCwywUtqQCodKekGSgm7", title: "Avatar 5"});
invokeAction({action: "deleteById", id: "ubCwywUtqQCodKekGSgm7"});